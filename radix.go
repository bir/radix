...
// Tree implements a radix tree. The main advantage over
// a standard hash map is prefix-based lookups and
// ordered iteration.  It is externally equivalent to
// Map[string, V].
...
// NewFromMap returns an empty Tree
